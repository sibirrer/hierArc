from hierarc.JAMLikelihood.jam_lens_sample_likelihood import JAMLensSampleLikelihood
...
class JAMCosmoLikelihood(object):
    ...
    def __init__(
        ...
        if kwargs_model.get("sigma_v_systematics", False) is True:
            normalized = True
        self._likelihoodLensSample = JAMLensSampleLikelihood(
            kwargs_likelihood_list,

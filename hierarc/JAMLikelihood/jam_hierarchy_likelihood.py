...
from hierarc.JAMLikelihood.jam_kin_scaling import JAMKinScaling
...
class JAMLensLikelihood(TransformedCosmography, LensLikelihoodBase, JAMKinScaling):
    """Master class containing the likelihood definitions of different analysis for a
    single lens.
    Axisymmetric JAM kinematics are done explicitly through the JAMKinScaling class
    with models computed using JAMPy, instead of making the correction from Huang et al. 2025.
    """

__author__ = "sibirrer", "ajshajib", "furcelay"

from hierarc.Likelihood.kin_scaling import ParameterScalingSingleMeasurement
import numpy as np


class JAMKinScalingParamManager(object):
...
class JAMKinScaling(JAMKinScalingParamManager):
    ...
    def __init__(
        ...
        if isinstance(j_kin_scaling_param_axes, list):
            ...
            self._dim_scaling = 1
        JAMKinScalingParamManager.__init__(

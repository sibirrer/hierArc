...
class DdtKinConstraints(IFUKin):
    ...
    def __init__(self, z_lens, z_source, ddt_sample, theta_E, theta_E_error, gamma, gamma_error, r_eff, r_eff_error,
        ...
        :param ddt_sample: numpy array with a sample reflecting the likelihood density in Ddt given imaging data and
         time delays.

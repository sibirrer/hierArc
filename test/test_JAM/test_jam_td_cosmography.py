...
from hierarc.JAM.jam_td_cosmography import JAMTDCosmography as TDCosmography
...
class TestTDCosmography(object):
    def setup_method(self):
        ...
        self.kwargs_lens = [
            {"theta_E": 1, "e1": 0.1, "e2": -0.2, "center_x": 0, "center_y": 0}
        ]
    ...
    def test_fermat_potential(self):
        ...
        fermat_pot_true = self.lens.fermat_potential(
        ...
        fermat_pot_true = self.lens.fermat_potential(
            self.image_x + diff, self.image_y, self.kwargs_lens
        )

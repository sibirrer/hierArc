...
class TestLensParam(object):
    ...
    def setup(self):
        self._param = LensParam(lambda_mst_sampling=True, lambda_mst_distribution='GAUSSIAN', kappa_ext_sampling=True,
                                ...
                                gamma_pl_sampling=True, gamma_pl_distribution='GAUSSIAN',
        ...
        kwargs_fixed = {'lambda_mst': 1, 'lambda_mst_sigma': 0.1, 'lambda_ifu': 1.1, 'lambda_ifu_sigma': 0.2,
                        'gamma_pl': 2, 'gamma_pl_sigma': 0.2,
                        'kappa_ext': 0.01, 'kappa_ext_sigma': 0.03, 'alpha_lambda': 0, 'beta_lambda': 0}
        self._param_fixed = LensParam(lambda_mst_sampling=True, lambda_mst_distribution='GAUSSIAN',
        ...
        self._param_log_scatter = LensParam(lambda_mst_sampling=True, lambda_mst_distribution='GAUSSIAN',
                                            kappa_ext_sampling=True, kappa_ext_distribution='GAUSSIAN',
                                            lambda_ifu_sampling=True, lambda_ifu_distribution='GAUSSIAN',
                                            alpha_lambda_sampling=True, beta_lambda_sampling=True, log_scatter=True,
                                            kwargs_fixed={})
